...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.lampaderum.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.lampaderum.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.lampaderum.domain.User.class.getName());
